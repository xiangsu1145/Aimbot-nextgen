...
class OpDefFlags {
    ...
    constexpr static uint32_t BIT_select_condition = 1024; // OpDef is the condition of a fully moved down select
    constexpr static uint32_t BIT_switchable_const = 2048; // dynamic switchable OpDef_ConstBase
  ...
  public:
    ...
    API_EXPORT bool is_select_condition() const { return (flags & BIT_select_condition) != 0; }
    API_EXPORT bool is_switchable_const() const { return (flags & BIT_switchable_const) != 0; }
    ...
    API_EXPORT bool set_select_condition(bool val = true) { return set_flag_state<BIT_select_condition>(val); }
    API_EXPORT bool set_switchable_const(bool val = true) { return set_flag_state<BIT_switchable_const>(val); }
