...
typedef struct QnnHtpContext_CustomConfig {
  ...
  union UNNAMED {
    ...
    // This field is a new option to enabled append mode weight sharing / reference weight sharing. Default to false.
    // Used in case of flexible context binary when preparing for multi ple SoCs.
